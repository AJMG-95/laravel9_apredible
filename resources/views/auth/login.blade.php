<x-layouts.app title="Login" meta-description="Login meta description">
    ...
    <form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-slate-800" action="{{ route('login') }}"
        method="POST">
        @csrf
        <div class="space-y-4">
            ...
            <label class="flex items-center" for="">
                <input
                    class="cursor-pointer border rounded dark:bg-slate-900 dark:focus:ring-slate-800 focus:ring-opacity-50"
